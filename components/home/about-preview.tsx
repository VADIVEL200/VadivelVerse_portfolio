        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
          ...
          >
            ...
            <p className="text-muted-foreground mb-6">
              A dedicated Professional Engineer committed to innovation,
              precision, and excellence in solving real-world engineering
              challenges through technical expertise and practical application.
            </p>
